...
class MessageCatalogue {
    ...
    /**
     * Проверьте, есть ли в этом каталоге сообщение для данного ключа, игнорируя резервный вариант, если он определен.
     *
     ...
     *
     * @return  string  Сообщение, если оно установлено, в противном случае ключ.
     */
    ...
    /**
     * Установить резервный вариант для этого каталога.
     *
