...
class LanguageFactory {
    ...
    /**
     * Получает новый объект Text для экземпляра языка.
     *
     * @param   Language|null  $language  Необязательный объект языка для внедрения, в противном случае загружается объект по умолчанию.
     *
     * @return  Text
     */
